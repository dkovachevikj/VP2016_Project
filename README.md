...
Максималниот број на филмови коишто може да се изнајмат е 5, потоа или ќе мора да се чека да помине рокот за изнајмување за некој од филмовите или да се врати некој филм. Ова може да се направи со клик на Return movie(s). Се отвара листа со изнајмените филмови и може да се изберат еден или повеќе филмови кои ќе се вратат.
